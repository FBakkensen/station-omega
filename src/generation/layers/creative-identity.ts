...
- crewRoster: 3-5 former crew members with name, role, and fate. They are historical station personnel used for logs and backstory, not living survivors in the current run
- toneKeywords: 3-5 words/phrases capturing the station's mood (e.g., "claustrophobic", "jury-rigged", "fading hope")
- visualStyleGuide: A rich visual style guide (50-80 words) in natural sentences describing the station's visual identity for AI image generation. The aesthetic must be DARK and DRAMATIC — this is a dying station, not a clean facility. Must cover: (1) architectural era or design language, (2) 2-3 dominant colors (always dark palette), (3) lighting character — MUST be dramatic directional light with deep shadows, never even/overhead/fluorescent, (4) weathered surface textures and materials showing age and damage, (5) heavy atmospheric quality (haze, particulate, vapor), (6) art treatment — cinematic with film grain. End with "No text or labels." Example: "Late-Soviet brutalist industrial architecture. Dominant colors: deep shadow black, amber emergency glow, rust-brown corrosion. Dramatic side-lighting cutting through heavy atmospheric haze, deep pools of darkness between fixtures. Corroded steel panels with exposed rivets, condensation-streaked bulkheads, rubber-gasket sealed hatches. Dense particulate haze from failing air scrubbers obscuring far walls. Rendered as dark cinematic concept art with film grain texture. No text or labels."
